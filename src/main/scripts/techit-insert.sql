...
# Password: 'abcd'
insert into users (id, username, hash, department, unitId, firstName, lastName, email, phoneNumber, position, enabled) values
	(3, 'rsanchez', '$2a$10$Xm5I2iYA/4vZytuGpVIro.zUAHGG0eAAcY2.aX20kRcM8u7AEmFom', 'Test', 2, 'Rick', 'Sanchez', 'test@gmail.com', '626-234-9999', 1, 1);
  
# Password: 'abcd'  
insert into users (id, username, hash, department, unitId, firstName, lastName, email, phoneNumber, position, enabled) values
    (4, 'msanchez', '$2a$10$Xm5I2iYA/4vZytuGpVIro.zUAHGG0eAAcY2.aX20kRcM8u7AEmFom', 'Test', 2, 'Morty', 'Sanchez', 'hello@gmail.com', '562-234-9876', 2, 1);
