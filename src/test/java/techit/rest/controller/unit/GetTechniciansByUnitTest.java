...
@Test(groups = "GetTechniciansByUnitTest")
@WebAppConfiguration
@ContextConfiguration(locations = "classpath:applicationContext.xml")
public class GetTechniciansByUnitTest extends AbstractTransactionalTestNGSpringContextTests {
	@Autowired
	...
	public void testOk() throws Exception{
		...
		MockHttpServletRequestBuilder builder = MockMvcRequestBuilders
				.get("/units/{unitId}/technicians",1)
